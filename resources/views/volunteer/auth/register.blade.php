...
<head>
    ...
    <title>Register — Event Volunteer Manager</title>
    ...
    <style>
        ...
        [data-theme="dark"] {
            ...
            --input-border: #3d4263;
            --input-focus-border: #6366f1;
            --input-focus-shadow: rgba(99,102,241,0.18);
            --input-color:  #e2e8f0;
            --placeholder:  #475569;
            --btn-ghost-border: #3d4263;
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .nav-btn-admin {
            ...
            color: var(--text-muted); font-size: 12.5px; padding: 7px 12px;
        }
...
<div class="page-wrap">
    <div class="auth-card">
        ...
        <p class="auth-sub">Join the volunteer community. It's free.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="department" class="form-control @error('department') is-invalid @enderror"
                           value="{{ old('department') }}" placeholder="e.g. Computer Science" required>
        ...
        <hr class="divider">
        <div class="auth-footer">Already have an account? <a href="{{ route('volunteer.login') }}">Sign in</a></div>
    </div>
</div>
