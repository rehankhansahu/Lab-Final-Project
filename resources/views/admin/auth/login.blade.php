...
<head>
    ...
    <title>Admin Login — Event Volunteer Manager</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .form-control {
            ...
            border-radius: 8px; color: var(--input-color);
            font-size: 14px; padding: 9px 13px; transition: all .18s; width: 100%;
        }
        .form-control::placeholder { color: var(--placeholder); }
        .form-control:focus {
            background: var(--input-bg); border-color: var(--accent);
            color: var(--input-color); box-shadow: 0 0 0 3px rgba(99,102,241,.15);
            outline: none;
        }
        .form-control.is-invalid { border-color: #ef4444; }
        .invalid-feedback { font-size: 12px; color: #ef4444; display: block; margin-top: 4px; }
        ...
        hr { border-color: var(--border); margin: 22px 0; }
        .auth-footer { text-align: center; font-size: 13px; color: var(--text-muted); }
        ...
        .alert-error {
            ...
            color: #ef4444; font-size: 13.5px; margin-bottom: 20px; text-align: left;
        }
        .alert-success-box {
            background: rgba(34,197,94,0.08); border: 1px solid rgba(34,197,94,0.25);
            border-radius: 8px; padding: 12px 16px;
            color: #22c55e; font-size: 13.5px; margin-bottom: 20px; text-align: left;
        }
    </style>
</head>
<body>
    ...
    <div class="container d-flex justify-content-between align-items-center">
        ...
        <div class="nav-actions">
            ...
            <a href="{{ route('volunteer.login') }}" class="nav-btn nav-btn-ghost">
                <i class="bi bi-person"></i>Volunteer Login
            </a>
...
<div class="page-wrap">
    <div class="auth-card">
        ...
        <hr>
        <div class="auth-footer"><a href="{{ route('home') }}">← Back to Home</a></div>
    </div>
</div>
